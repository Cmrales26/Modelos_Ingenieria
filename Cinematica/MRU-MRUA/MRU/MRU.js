...
function simulador1(params) {
    ; (function () {
        ...
        async function __main__() {
            ...
            var version, print, arange, __name__, type, ρσ_ls, p_i, distancia, time, canva1, bolita, g, plot1;
            ...
            canva1 = ρσ_interpolate_kwargs.call(this, canvas, [ρσ_desugar_kwargs({ width: 480, height: 150, background: vector(250, 250, 250) })]);
            bolita = ρσ_interpolate_kwargs.call(this, sphere, [ρσ_desugar_kwargs({ pos: p_i, color: color.blue, radius: 1, make_trail: true })]);
            g = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({ width: 480, height: 150, xtitle: "<i>Tiempo(s)<\/i>", ytitle: "<i>Velocidad(m/s)</i>", xmin: 0, xmax: distancia, fast: true })]);
...
;(function() {;
    ...
    "use strict";
        ...
        var version, print, arange, __name__, type, ρσ_ls, p_i, velocidad, tiempoin, tiempofin, ratspeed, vport, res, g, plot1;
        version = ρσ_list_decorate([ "3.2", "glowscript" ]);
        Array.prototype['+'] = function(r) {return this.concat(r)}
        Array.prototype['*'] = function(r) {return __array_times_number(this, r)}
        window.__GSlang = "vpython";
        ...
        if (res["<"](0)) {
            "12";
            g = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({width: 600, height: 225, xtitle: "<i>Tiempo<\/i>", ytitle: "<i>Posicion</i>", xmin: p_i, xmax: tiempofin, fast: true})]);
            "13";
            plot1 = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({graph: g, color: color.blue, dot: true, dot_color: color.blue})]);
            "14";
        } else {
    ...
    if (!__main__.__module__) Object.defineProperties(__main__, {
        ...
        ; $(function () { window.__context = { glowscript_container: $("#simulacion-pt").removeAttr("id") }; __main__() })
    })()
}
