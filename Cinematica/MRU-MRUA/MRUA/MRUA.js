...
function grficap_vs_t() {
    (function () {
        ...
        async function __main__() {
            ...
            var version, print, arange, __name__, type, ρσ_ls, posicion_i, velocidad_i, tiempo_i, tiempo_f, aceleracion, deltaTiempo, distancia_f, g, plot1;
            ...
            "9";
            distancia_f = 0;
            g = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({ width: 600, height: 225, xtitle: "<i>Tiempo<\/i>", ytitle: "<i>Posicion</i>", xmin: tiempo_i, xmax: deltaTiempo, fast: true })]);
            plot1 = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({ graph: g, color: color.blue, dot: true, dot_color: color.blue })]);
            plot1.plot(tiempo_i, distancia_f);
            while (tiempo_i["<"](deltaTiempo)) {
                (await rate(10));
                tiempo_i = tiempo_i["+"](1);
                distancia_f = posicion_i["+"](velocidad_i["*"](tiempo_i))["+"](1["/"](2)["*"](aceleracion)["*"](Math.pow(tiempo_i, 2)));
                plot1.plot(tiempo_i, distancia_f);
                print(distancia_f);
            }
        };
        ...
        $(function () { window.__context = { glowscript_container: $("#grficap-vs-t").removeAttr("id") }; __main__() })
    })()
...
function grficap_vs_t_speeds() {
    ...
    const Posicion_f = (v_i * deltat) + (1 / 2 * ((aceleracion) * Math.pow(deltat, 2)))
    ...
    const expression = v_i.toString() + "*t+(1/2)" + aceleracion.toString() + "*t^2"
    Resultado = math.derivative(expression, 't').evaluate({ t: tiempo_estudio.value })
...
function grafica_v_vs_t() {
    (function () {
        ...
        async function __main__() {
            ...
            var version, print, arange, __name__, type, ρσ_ls, velocidad_i, aceleracion, tiempo, t_i, velocidad_f, g, plot1;
            version = ρσ_list_decorate(["3.2", "glowscript"]);
            Array.prototype['+'] = function (r) { return this.concat(r) }
            Array.prototype['*'] = function (r) { return __array_times_number(this, r) }
            window.__GSlang = "vpython";
            ...
            t_i = 0;
            velocidad_f = 0;
            g = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({ width: 600, height: 225, xtitle: "<i>Tiempo<\/i>", ytitle: "<i>Velocidad</i>", xmin: 0, xmax: tiempo, fast: true })]);
            plot1 = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({ graph: g, color: color.blue, dot: true, dot_color: color.blue })]);
        ...
        ; $(function () { window.__context = { glowscript_container: $("#grficap-vs-t-out").removeAttr("id") }; __main__() })
    })()
}
...
function grafica_v_vs_t_n() {
    ; (function () {
        ...
        ; $(function () { window.__context = { glowscript_container: $("#grficap-vs-t-out-neg").removeAttr("id") }; __main__() })
    })()
    // END JAVASCRIPT
}
...
function grafica_a_vs_t(params) {
    ; (function () {
        ...
        async function __main__() {
            ...
            var version, print, arange, __name__, type, ρσ_ls, pr, velocidadFinal, tiempoFinal, aceleracion, g, plot1;
            version = ρσ_list_decorate(["3.2", "glowscript"]);
            Array.prototype['+'] = function (r) { return this.concat(r) }
            Array.prototype['*'] = function (r) { return __array_times_number(this, r) }
            window.__GSlang = "vpython";
            ...
            g = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({ width: 600, height: 225, xtitle: "<i>Tiempo<\/i>", ytitle: "<i>Aceleracion</i>", xmin: pr, xmax: tiempoFinal, fast: true })]);
            plot1 = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({ graph: g, color: color.blue, dot: true, dot_color: color.blue })]);
        ...
        ; $(function () { window.__context = { glowscript_container: $("#grafica-a-vs-t").removeAttr("id") }; __main__() })
    })()
}
...
function simulacionCaidaL() {
    ...
    if (simu == null) {
        ...
        async function __main__() {
            ...
            var version, print, arange, __name__, type, ρσ_ls, canva1, ground, altura, Safi, time, time_step, dvx, dvy, dx, dy;
            version = ρσ_list_decorate(["3.2", "glowscript"]);
            Array.prototype['+'] = function (r) { return this.concat(r) }
            Array.prototype['*'] = function (r) { return __array_times_number(this, r) }
            window.__GSlang = "vpython";
            ...
            strings();
            canva1 = ρσ_interpolate_kwargs.call(this, canvas, [ρσ_desugar_kwargs({ width: 700, height: 300, background: vector(250, 250, 250) })]);
            ground = ρσ_interpolate_kwargs.call(this, box, [ρσ_desugar_kwargs({ pos: vector(0, 0, 0), color: color.blue, size: vector(10000, .5, .01) })]);
            canva1.range = 4;
            ...
            async function marker(x, y, col) {
                var ρσ_ls, a;
                (await sleep(.1));
                a = ρσ_interpolate_kwargs.call(this, sphere, [ρσ_desugar_kwargs({ pos: vector(x, y, 0), radius: .2, color: col, make_trail: true, trail_type: "points", interval: 5, initial_pos: vector(x, y, 0), distance: 0 })]);
                return a;
            };
            if (!marker.__argnames__) Object.defineProperties(marker, {
            ...
            if (!accelerate.__argnames__) Object.defineProperties(accelerate, {
            ...
            async function move(name, dx, dy) {
                ...
                name.distance = name.distance["+"](sqrt(Math.pow(dx, 2)["+"](Math.pow(dy, 2))));
                return;
            };
            ...
            if (!distance.__argnames__) Object.defineProperties(distance, {
        ...
        ; $(function () { window.__context = { glowscript_container: $("#simulacionCaidaLibre").removeAttr("id") }; __main__() })
    })()
}
...
;(function() {;
    ...
    "use strict";
        ...
        var version, print, arange, __name__, type, ρσ_ls, canva1, ground, altura, posicion_inicial_x, position_graph, velocity_graph, Safi, time, time_step, dvx, dvy, dx, dy;
        version = ρσ_list_decorate([ "3.2", "glowscript" ]);
        Array.prototype['+'] = function(r) {return this.concat(r)}
        Array.prototype['*'] = function(r) {return __array_times_number(this, r)}
        window.__GSlang = "vpython";
        ...
        strings();
        "3";
        canva1 = ρσ_interpolate_kwargs.call(this, canvas, [ρσ_desugar_kwargs({width: 100, height: 68.6, background: vector(250, 250, 250), resizable: false})]);
        "4";
        canva1.visible = false;
        "6";
        ground = ρσ_interpolate_kwargs.call(this, box, [ρσ_desugar_kwargs({pos: vector(0, 0, 0), color: color.blue, size: vector(20, .2, .01)})]);
        "8";
        altura = parseFloat(altura_y_s.value);
        "9";
        posicion_inicial_x = 0;
        "11";
        position_graph = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({xtitle: "time", ytitle: "position", width:475})]);
        "12";
        velocity_graph = ρσ_interpolate_kwargs.call(this, graph, [ρσ_desugar_kwargs({xtitle: "time", ytitle: "velocity"})]);
        "15";
        Safi = (await marker(.5, altura, color.red));
        "16";
        Safi.vx = parseFloat(Velocidad_i_x.value);
        "17";
        Safi.vy = parseFloat(velocidad_i_y.value);
        ...
        Safi.ay = 1["-u"]()["*"](9.8);
        "24";
        Safi.xcurve = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({label: "Safi's x", color: color.red, graph: position_graph, dot: true, dot_color: color.red})]);
        "25";
        Safi.ycurve = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({label: "Safi's y", color: color.blue, graph: position_graph, dot: true, dot_color: color.blue})]);
        "27";
        Safi.vxcurve = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({label: "Safi's vx", color: color.red, graph: velocity_graph, dot: true, dot_color: color.red})]);
        "28";
        Safi.vycurve = ρσ_interpolate_kwargs.call(this, gcurve, [ρσ_desugar_kwargs({label: "Safi's vy", color: color.blue, graph: velocity_graph, dot: true, dot_color: color.blue})]);
        "32";
        time = 0;
        "33";
        time_step = .01;
        ...
        while (Safi.pos.y[">="](ground.pos.y)) {
            ...
            (await move(Safi, dx, dy));
            "45";
            ρσ_interpolate_kwargs.call(Safi.xcurve, Safi.xcurve.plot, [ρσ_desugar_kwargs({pos: [time, 
            Safi.pos.x]})]);
            "46";
            ρσ_interpolate_kwargs.call(Safi.ycurve, Safi.ycurve.plot, [ρσ_desugar_kwargs({pos: [time, 
            Safi.pos.y]})]);
            "47";
            ρσ_interpolate_kwargs.call(Safi.vxcurve, Safi.vxcurve.plot, [ρσ_desugar_kwargs({pos: [time, 
            Safi.vx]})]);
            "48";
            ρσ_interpolate_kwargs.call(Safi.vycurve, Safi.vycurve.plot, [ρσ_desugar_kwargs({pos: [time, 
            Safi.vy]})]);
            "50";
            time=time["+"](time_step);
        }
        ...
        async function marker(x, y, col) {
            ...
            (await sleep(.1));
            "56";
            a = ρσ_interpolate_kwargs.call(this, sphere, [ρσ_desugar_kwargs({pos: vector(x, y, 0), radius: 0, initial_pos: vector(x, y, 0), distance: 0})]);
            "57";
            return a;
        };
        if (!marker.__argnames__) Object.defineProperties(marker, {
    ...
    ;$(function(){ window.__context = { glowscript_container: $("#distanciavstiempocaidaL").removeAttr("id") }; __main__() })})()
    // END JAVASCRIPT
}
altura_y_s.addEventListener('change', (event) => {
    simulacionCaidaL()
